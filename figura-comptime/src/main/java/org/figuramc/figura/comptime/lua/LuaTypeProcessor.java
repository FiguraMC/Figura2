package org.figuramc.figura.comptime.lua;

import com.google.auto.service.AutoService;
import org.figuramc.figura.comptime.lua.annotations.*;
...
@SupportedAnnotationTypes("org.figuramc.figura.comptime.lua.annotations.LuaTypeAPI")
        ...
        for (TypeElement annotation : annotations) {
            ...
            for (Element element : roundEnv.getElementsAnnotatedWith(annotation)) {
                ...
                try {
                    ...
                    // Package and imports
                    output.append("package org.figuramc.figura.script_languages.lua.generated;\n\n");

                    output.append("import org.figuramc.figura.script_languages.lua.cobalt.org.squiddev.cobalt.Constants;\n");
                    output.append("import org.figuramc.figura.script_languages.lua.cobalt.org.squiddev.cobalt.LuaState;\n");
                    output.append("import org.figuramc.figura.script_languages.lua.cobalt.org.squiddev.cobalt.LuaUserdata;\n");
                    output.append("import org.figuramc.figura.script_languages.lua.cobalt.org.squiddev.cobalt.LuaTable;\n");
                    output.append("import org.figuramc.figura.script_languages.lua.cobalt.org.squiddev.cobalt.LuaDouble;\n");
                    output.append("import org.figuramc.figura.script_languages.lua.cobalt.org.squiddev.cobalt.LuaInteger;\n");
                    output.append("import org.figuramc.figura.script_languages.lua.cobalt.org.squiddev.cobalt.LuaBoolean;\n");
                    output.append("import org.figuramc.figura.script_languages.lua.cobalt.org.squiddev.cobalt.LuaString;\n");
                    output.append("import org.figuramc.figura.script_languages.lua.cobalt.org.squiddev.cobalt.LuaError;\n");
                    output.append("import org.figuramc.figura.script_languages.lua.cobalt.org.squiddev.cobalt.ErrorFactory;\n");
                    output.append("import org.figuramc.figura.script_languages.lua.cobalt.org.squiddev.cobalt.function.LibFunction;\n\n");
                    output.append("import org.figuramc.figura.script_languages.lua.FiguraMetatables;\n");
                    output.append("import org.figuramc.figura.avatars.AvatarError;\n");
                    ...
                    if (luaTypeAPI.hasSuperclass()) {
                        ...
                        output.append("    public static LuaTable createMetatable(LuaState state, @NotNull LuaTable superclassMetatable) throws LuaError, AvatarError {\n");
                    } else {
                        output.append("    public static LuaTable createMetatable(LuaState state) throws LuaError, AvatarError {\n");
                    }
                    ...
                    JavaFileObject fileObject = filer.createSourceFile("org.figuramc.figura.script_languages.lua.generated." + generatedClassName);
    ...
    private void writeLuaLambda(
        ...
        for (ExecutableElement method : methods) {
            ...
            for (int i = 0; i < params.size(); i++) {
                ...
                switch (param.asType().getKind()) {
                    ...
                    case DECLARED -> {
                        ...
                        if (typeUtils.isSameType(elementUtils.getTypeElement("org.figuramc.figura.script_languages.lua.cobalt.org.squiddev.cobalt.LuaValue").asType(), param.asType())) {
                            output.append(indent).append("        args.arg(" + (i + 1 + argOffset) + ")");
                        } else if (typeUtils.isSameType(elementUtils.getTypeElement("org.figuramc.figura.script_languages.lua.cobalt.org.squiddev.cobalt.LuaTable").asType(), param.asType())) {
                            output.append(indent).append("        args.arg(" + (i + 1 + argOffset) + ").checkTable(s)");
                        } else if (typeUtils.isSameType(elementUtils.getTypeElement("org.figuramc.figura.script_languages.lua.cobalt.org.squiddev.cobalt.LuaString").asType(), param.asType())) {
                            output.append(indent).append("        args.arg(" + (i + 1 + argOffset) + ").checkLuaString(s)");
                        } else if (typeUtils.isSameType(elementUtils.getTypeElement("org.figuramc.figura.script_languages.lua.cobalt.org.squiddev.cobalt.function.LuaFunction").asType(), param.asType())) {
            ...
            if (method.getAnnotation(LuaReturnSelf.class) != null) {
                ...
                case DECLARED -> {
                    // Check for built-in supported types.
                    if (typeUtils.isSubtype(method.getReturnType(), elementUtils.getTypeElement("org.figuramc.figura.script_languages.lua.cobalt.org.squiddev.cobalt.Varargs").asType())) {
                    ...
                    if (typeUtils.isSameType(elementUtils.getTypeElement("java.lang.String").asType(), method.getReturnType())) {
                        ...
                        output.append(indent).append("    yield " + ((TypeElement) typeUtils.asElement(apiType)).getQualifiedName() + ".wrap(result, s);\n");
                    }
                }
