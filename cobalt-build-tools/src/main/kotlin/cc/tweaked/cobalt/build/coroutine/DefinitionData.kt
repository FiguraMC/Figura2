...
enum class InstrumentType {
	/**
	 * This method is annotated with the [org.figuramc.figura.script_languages.lua.cobalt.cc.tweaked.cobalt.build.coroutine.AUTO_UNWIND], and so should be instrumented
	 * as such.
	 */
	AUTO_UNWIND,
...
private val builtinMethods = run {
	val opHelper = "org/figuramc/figura/script_languages/lua/cobalt/org/squiddev/cobalt/OperationHelper"
	val dispatch = "org/figuramc/figura/script_languages/lua/cobalt/org/squiddev/cobalt/function/Dispatch"
	...
	mapOf(
		Desc("org/figuramc/figura/script_languages/lua/cobalt/org/squiddev/cobalt/compiler/InputReader", "read", "()I") to YieldType.Resume,
		Desc("org/figuramc/figura/script_languages/lua/cobalt/org/squiddev/cobalt/unwind/SuspendedFunction", "call", "(Lorg/figuramc/figura/script_languages/lua/cobalt/org/squiddev/cobalt/LuaState;)Ljava/lang/Object;") to YieldType.Resume,
