...
import org.figuramc.figura.script_languages.molang.compile.MolangParser;
import org.figuramc.figura.script_languages.molang.func.*;
 ...
 */
public class MolangInstance<Actor> {
    ...
    private final Map<String, ? extends Query<? super Actor>> queries;
    ...
    private final AllocationTracker.State allocState;
    ...
    public MolangInstance(@Nullable Actor initialActor, @Nullable AllocationTracker allocationTracker, Map<String, ? extends Query<? super Actor>> queries) throws AvatarError {
    ...
    public ActorVariable getOrCreateActorVariable(String variableName, int size) throws AvatarError, MolangCompileException {
    ...
    public float[] getTempStack(int requiredSize) throws AvatarError {
        if (reEntrantFlag == 2) {
    ...
    // Get query
    public @Nullable Query<? super Actor> getQuery(String name) { return queries.get(name); }
    ...
    @FunctionalInterface
    public interface Query<Actor> { MolangExpr bind(MolangParser parser, List<MolangExpr> args, String source, int funcNameStart, int funcNameEnd) throws AvatarError, MolangCompileException; }
    ...
    public CompiledMolang<Actor> compile(String source) throws AvatarError, MolangCompileException {

        // Parse:
        MolangParser parser = new MolangParser(source, this);
