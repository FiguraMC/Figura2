...
public class Vec2API {
    ...
    @LuaExpose @LuaPassState public static Vector2d __add(LuaState s, Vector2d self, LuaValue unknown) throws LuaError, AvatarError {
    ...
    @LuaExpose @LuaPassState public static Vector2d __sub(LuaState s, Vector2d self, LuaValue unknown) throws LuaError, AvatarError {
        Vector2d other = unknown.optUserdata(s, Vector2d.class, null);
        if (other != null) return new Vector2d(self).sub(other);
        double num = unknown.checkDouble(s);
        return new Vector2d(self).sub(num, num);
    }
    @LuaExpose @LuaPassState public static Vector2d __mul(LuaState s, Vector2d self, LuaValue unknown) throws LuaError, AvatarError {
        Vector2d other = unknown.optUserdata(s, Vector2d.class, null);
        if (other != null) return new Vector2d(self).mul(other);
        double num = unknown.checkDouble(s);
        return new Vector2d(self).mul(num);
    }
    @LuaExpose @LuaPassState public static Vector2d __div(LuaState s, Vector2d self, LuaValue unknown) throws LuaError, AvatarError {
        Vector2d other = unknown.optUserdata(s, Vector2d.class, null);
    ...
    @LuaExpose @LuaPassState public static Vector2d __mod(LuaState s, Vector2d self, LuaValue unknown) throws LuaError, AvatarError {
        Vector2d other = unknown.optUserdata(s, Vector2d.class, null);
    ...
    @LuaExpose @LuaPassState public static boolean __eq(LuaState s, Vector2d self, LuaValue unknown) throws LuaError, AvatarError {
        Vector2d other = unknown.optUserdata(s, Vector2d.class, null);
        if (other != null) return self.equals(other);
        double num = unknown.checkDouble(s);
        return self.equals(num, num);
    }
    @LuaExpose @LuaPassState public static boolean __lt(LuaState s, Vector2d self, LuaValue unknown) throws LuaError, AvatarError {
        Vector2d other = unknown.optUserdata(s, Vector2d.class, null);
        if (other != null) return self.x < other.x && self.y < other.y;
        double num = unknown.checkDouble(s);
        return self.x < num && self.y < num;
    }
    @LuaExpose @LuaPassState public static boolean __le(LuaState s, Vector2d self, LuaValue unknown) throws LuaError, AvatarError {
        Vector2d other = unknown.optUserdata(s, Vector2d.class, null);
        if (other != null) return self.x <= other.x && self.y <= other.y;
        double num = unknown.checkDouble(s);
        return self.x <= num && self.y <= num;
    ...
    @LuaExpose @LuaPassState public static LuaValue __index(LuaState s, Vector2d self, LuaValue key) throws LuaError, AvatarError {
    ...
    @LuaExpose @LuaPassState public static void __newindex(LuaState s, Vector2d self, LuaValue key, LuaValue value) throws LuaError, AvatarError {
    ...
    private static void setSwizzle(Vector2d v, char c, double num, LuaState state) throws LuaError, AvatarError {
        switch (c) {
            case '_' -> {}
            case 'x', 'r', 'u' -> v.x = num;
            case 'y', 'g', 'v' -> v.y = num;
