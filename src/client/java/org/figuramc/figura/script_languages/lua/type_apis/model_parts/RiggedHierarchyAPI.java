...
public class RiggedHierarchyAPI {
    ...
    public static LuaUserdata wrap(RiggedHierarchy<?> hierarchy, LuaState state) {
        return switch (hierarchy) {
            case FiguraModelPart figuraPart -> FiguraPartAPI.wrap(figuraPart, state);
            case VanillaRendering.VanillaPart vanillaPart -> VanillaPartAPI.wrap(vanillaPart, state);
