package org.figuramc.figura.script_languages.lua.type_apis.math.vector;
...
import static org.figuramc.figura.script_languages.lua.cobalt.org.squiddev.cobalt.Constants.TNUMBER;

@LuaTypeAPI(typeName = "Vec4", wrappedClass = Vector4d.class)
public class Vec4API {

    // TODO make this use memory
    public static LuaUserdata wrap(Vector4d vec, LuaState state) {
    ...
    @LuaExpose @LuaPassState public static Vector4d __add(LuaState s, Vector4d self, LuaValue unknown) throws LuaError, AvatarError {
    ...
    @LuaExpose @LuaPassState public static Vector4d __sub(LuaState s, Vector4d self, LuaValue unknown) throws LuaError, AvatarError {
        Vector4d other = unknown.optUserdata(s, Vector4d.class, null);
        if (other != null) return new Vector4d(self).sub(other);
        double num = unknown.checkDouble(s);
        return new Vector4d(self).sub(num, num, num, num);
    }
    @LuaExpose @LuaPassState public static Vector4d __mul(LuaState s, Vector4d self, LuaValue unknown) throws LuaError, AvatarError {
        Vector4d other = unknown.optUserdata(s, Vector4d.class, null);
        if (other != null) return new Vector4d(self).mul(other);
        double num = unknown.checkDouble(s);
        return new Vector4d(self).mul(num);
    }
    @LuaExpose @LuaPassState public static Vector4d __div(LuaState s, Vector4d self, LuaValue unknown) throws LuaError, AvatarError {
        Vector4d other = unknown.optUserdata(s, Vector4d.class, null);
    ...
    @LuaExpose @LuaPassState public static Vector4d __mod(LuaState s, Vector4d self, LuaValue unknown) throws LuaError, AvatarError {
        Vector4d other = unknown.optUserdata(s, Vector4d.class, null);
    ...
    @LuaExpose @LuaPassState public static boolean __eq(LuaState s, Vector4d self, LuaValue unknown) throws LuaError, AvatarError {
        Vector4d other = unknown.optUserdata(s, Vector4d.class, null);
        if (other != null) return self.equals(other);
        double num = unknown.checkDouble(s);
        return self.equals(num, num, num, num);
    }
    @LuaExpose @LuaPassState public static boolean __lt(LuaState s, Vector4d self, LuaValue unknown) throws LuaError, AvatarError {
        Vector4d other = unknown.optUserdata(s, Vector4d.class, null);
    ...
    @LuaExpose @LuaPassState public static boolean __le(LuaState s, Vector4d self, LuaValue unknown) throws LuaError, AvatarError {
        Vector4d other = unknown.optUserdata(s, Vector4d.class, null);
        if (other != null) return self.x <= other.x && self.y <= other.y && self.z <= other.z && self.w <= other.w;
        double num = unknown.checkDouble(s);
        return self.x <= num && self.y <= num && self.z <= num && self.w <= num;
    ...
    @LuaExpose @LuaPassState public static LuaValue __index(LuaState s, Vector4d self, LuaValue key) throws LuaError, AvatarError {
    ...
    @LuaExpose @LuaPassState public static void __newindex(LuaState s, Vector4d self, LuaValue key, LuaValue value) throws LuaError, AvatarError {
    ...
    private static void setSwizzle(Vector4d v, char c, double num, LuaState state) throws LuaError, AvatarError {
        switch (c) {
            case '_' -> {}
            case 'x', 'r', 'u' -> v.x = num;
            case 'y', 'g', 'v' -> v.y = num;
