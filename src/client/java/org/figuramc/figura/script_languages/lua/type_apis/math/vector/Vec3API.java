...
public class Vec3API {
    ...
    @LuaExpose @LuaPassState public static Vector3d __add(LuaState s, Vector3d self, LuaValue unknown) throws LuaError, AvatarError {
    ...
    @LuaExpose @LuaPassState public static Vector3d __sub(LuaState s, Vector3d self, LuaValue unknown) throws LuaError, AvatarError {
        Vector3d other = unknown.optUserdata(s, Vector3d.class, null);
        if (other != null) return new Vector3d(self).sub(other);
        double num = unknown.checkDouble(s);
        return new Vector3d(self).sub(num, num, num);
    }
    @LuaExpose @LuaPassState public static Vector3d __mul(LuaState s, Vector3d self, LuaValue unknown) throws LuaError, AvatarError {
        Vector3d other = unknown.optUserdata(s, Vector3d.class, null);
        if (other != null) return new Vector3d(self).mul(other);
        double num = unknown.checkDouble(s);
        return new Vector3d(self).mul(num);
    }
    @LuaExpose @LuaPassState public static Vector3d __div(LuaState s, Vector3d self, LuaValue unknown) throws LuaError, AvatarError {
        Vector3d other = unknown.optUserdata(s, Vector3d.class, null);
    ...
    @LuaExpose @LuaPassState public static Vector3d __mod(LuaState s, Vector3d self, LuaValue unknown) throws LuaError, AvatarError {
        Vector3d other = unknown.optUserdata(s, Vector3d.class, null);
    ...
    @LuaExpose @LuaPassState public static boolean __eq(LuaState s, Vector3d self, LuaValue unknown) throws LuaError, AvatarError {
        Vector3d other = unknown.optUserdata(s, Vector3d.class, null);
        if (other != null) return self.equals(other);
        double num = unknown.checkDouble(s);
        return self.equals(num, num, num);
    }
    @LuaExpose @LuaPassState public static boolean __lt(LuaState s, Vector3d self, LuaValue unknown) throws LuaError, AvatarError {
        Vector3d other = unknown.optUserdata(s, Vector3d.class, null);
        if (other != null) return self.x < other.x && self.y < other.y && self.z < other.z;
        double num = unknown.checkDouble(s);
        return self.x < num && self.y < num && self.z < num;
    }
    @LuaExpose @LuaPassState public static boolean __le(LuaState s, Vector3d self, LuaValue unknown) throws LuaError, AvatarError {
        Vector3d other = unknown.optUserdata(s, Vector3d.class, null);
        if (other != null) return self.x <= other.x && self.y <= other.y && self.z <= other.z;
        double num = unknown.checkDouble(s);
        return self.x <= num && self.y <= num && self.z <= num;
    ...
    @LuaExpose @LuaPassState public static LuaValue __index(LuaState s, Vector3d self, LuaValue key) throws LuaError, AvatarError {
    ...
    @LuaExpose @LuaPassState public static void __newindex(LuaState s, Vector3d self, LuaValue key, LuaValue value) throws LuaError, AvatarError {
    ...
    private static void setSwizzle(Vector3d v, char c, double num, LuaState state) throws LuaError, AvatarError {
        switch (c) {
            case '_' -> {}
            case 'x', 'r', 'u' -> v.x = num;
            case 'y', 'g', 'v' -> v.y = num;
