...
public record FunctionDebugHook(LuaFunction function) implements DebugHook {
	...
	@Override
	public void onCall(LuaState state, DebugState ds, DebugFrame frame) throws LuaError, AvatarError, UnwindThrowable {
		Dispatch.call(state, function, CALL, Constants.NIL);
	}

	@Override
	public void onReturn(LuaState state, DebugState ds, DebugFrame frame) throws LuaError, AvatarError, UnwindThrowable {
		Dispatch.call(state, function, RETURN, Constants.NIL);
	}

	@Override
	public void onCount(LuaState state, DebugState ds, DebugFrame frame) throws LuaError, AvatarError, UnwindThrowable {
		Dispatch.call(state, function, COUNT, Constants.NIL);
	}

	@Override
	public void onLine(LuaState state, DebugState ds, DebugFrame frame, int newLine) throws LuaError, AvatarError, UnwindThrowable {
